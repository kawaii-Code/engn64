...
#define LEVELS_COUNT 20

const char *DEFAULT_TILEMAP = "....k..........."
                              "..====.........."
                              "................"
                              "=|..b.......c..."
                              "..===|..../==|.."
...
typedef struct {
    ...
    Player                   player;
    Tilemap                  tilemap;
    Dynamic_Array_Of_Boxes   boxes;
    Dynamic_Array_Of_Candies candies;
    Dynamic_Array_Of_Doors   doors;
    Dynamic_Array_Of_Rects   keys;
} Level;
